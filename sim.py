...
n_steps_equil = int(ceil(100 / dt)) # 500 ps
n_steps_save  = int(ceil(100 / dt)) # 500 ps
...
if os.path.isfile(checkpoint_fp):
    ...
    PDBFile.writeFile(pdb.topology, pdb.positions, open('protein_equil.pdb', 'w'))
...
simulation.reporters.append(XTCReporter(traj_fp, n_steps_save, append=append_xtc))
